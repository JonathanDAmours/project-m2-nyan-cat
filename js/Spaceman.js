...
class Astronaut {
  ...
  // - astronautSpot is the position of the enemy (either 0, 1, 2, 3 or 4)
  ...
  constructor(theRoot, astronautSpot) {
    ...
    this.x = astronautSpot * ENEMY_WIDTH;
    ...
    this.domElement.src = "./images/astronaut.png";
